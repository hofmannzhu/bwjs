...
namespace XBWN.BLL
{
    ...
    /// 信博维诺借款表
    /// </summary>
    public partial class xbwn_LoanBLL
    {
        private readonly xbwn_LoanDAL dal = new xbwn_LoanDAL();
        ...
        /// 获得数据列表
        /// </summary>
        public List<XBWN.Model.xbwn_Loan> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<XBWN.Model.xbwn_Loan> DataTableToList(DataTable dt)
        {
            List<XBWN.Model.xbwn_Loan> modelList = new List<XBWN.Model.xbwn_Loan>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                XBWN.Model.xbwn_Loan model;
        ...
        {
            return dal.GetModelByBorrowNo(borrowNo);
        }
        /// <summary>
        /// 更新一条数据
        /// </summary>
        ...
        {
            return dal.Update(tradePassword, tradePasswordSecond,flag, borrowNo);
        }
        /// <summary>
        /// 删除一条数据
        /// </summary>
