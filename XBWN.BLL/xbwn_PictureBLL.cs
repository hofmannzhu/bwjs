...
namespace XBWN.BLL
{
    ...
    /// 信博维诺图片表
    /// </summary>
    public partial class xbwn_PictureBLL
    {
        private readonly xbwn_PictureDAL dal = new xbwn_PictureDAL();
        ...
        /// 获得数据列表
        /// </summary>
        public List<XBWN.Model.xbwn_Picture> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<XBWN.Model.xbwn_Picture> DataTableToList(DataTable dt)
        {
            List<XBWN.Model.xbwn_Picture> modelList = new List<XBWN.Model.xbwn_Picture>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                XBWN.Model.xbwn_Picture model;
        ...
        /// 得到一个对象实体
        /// </summary>
        public XBWN.Model.xbwn_Picture DataRowToModel(DataRow row)
        {
