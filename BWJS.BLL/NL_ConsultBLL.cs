...
namespace BWJS.BLL
{
    ...
    /// 网贷申请
    /// </summary>
    public partial class NL_ConsultBLL
    {
        private readonly BWJS.DAL.NL_ConsultDAL dal = new BWJS.DAL.NL_ConsultDAL();
        ...
        /// 获得数据列表
        /// </summary>
        public List<BWJS.Model.NL_Consult> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<BWJS.Model.NL_Consult> DataTableToList(DataTable dt)
        {
            List<BWJS.Model.NL_Consult> modelList = new List<BWJS.Model.NL_Consult>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                BWJS.Model.NL_Consult model;
        ...
        public bool Delete(int ConsultId, int userId)
        {
            ...
            return dal.Delete(ConsultId, userId);
        }
        /// <summary>
        /// 批量删除一批数据
        /// </summary>
        ...
        {
            return dal.DeleteList(ConsultIdlist, userId);
        }
        /// <summary>
        /// 分页获得数据列表
        /// </summary>
        ...
        {
            return dal.GetConsultId(strWhere);
        }
        ...
        {
            return dal.Update(consultId, status);
        }
