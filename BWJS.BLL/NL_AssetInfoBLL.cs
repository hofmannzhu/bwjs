...
namespace BWJS.BLL {
    ...
    /// 资产信息
    /// </summary>
		public partial class NL_AssetInfoBLL
	{
   		     
		private readonly BWJS.DAL.NL_AssetInfoDAL dal=new BWJS.DAL.NL_AssetInfoDAL();
		public NL_AssetInfoBLL()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public BWJS.Model.NL_AssetInfo GetModelByCache(int ConsultId)
		{
			
			string CacheKey = "NL_AssetInfoModel-" + ConsultId;
			...
			return (BWJS.Model.NL_AssetInfo)objModel;
		}*/
		...
		/// 获得数据列表
		/// </summary>
		public List<BWJS.Model.NL_AssetInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<BWJS.Model.NL_AssetInfo> DataTableToList(DataTable dt)
		{
			List<BWJS.Model.NL_AssetInfo> modelList = new List<BWJS.Model.NL_AssetInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				BWJS.Model.NL_AssetInfo model;
