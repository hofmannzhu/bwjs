...
namespace BWJS.BLL
{
    ...
    /// 渠道网贷扩展
    /// </summary>
    public partial class CompanyNetLoanBLL
    {
        private readonly CompanyNetLoanDAL dal = new CompanyNetLoanDAL();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public BWJS.Model.CompanyNetLoan GetModelByCache(int CompanyId)
		{
			
			string CacheKey = "CompanyNetLoanModel-" + CompanyId;
			...
			return (BWJS.Model.CompanyNetLoan)objModel;
		}*/
        ...
        /// 获得数据列表
        /// </summary>
        public List<BWJS.Model.CompanyNetLoan> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<BWJS.Model.CompanyNetLoan> DataTableToList(DataTable dt)
        {
            List<BWJS.Model.CompanyNetLoan> modelList = new List<BWJS.Model.CompanyNetLoan>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                BWJS.Model.CompanyNetLoan model;
