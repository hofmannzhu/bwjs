...
namespace BWJS.BLL
{
    ...
    {
        private readonly static SysConfigDAL sdal = new SysConfigDAL();
        private readonly SysConfigDAL dal = new SysConfigDAL();
        public SysConfigBLL()
        { }
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public BWJS.Model.SysConfig GetModelByCache(int Id)
		{
			
			string CacheKey = "SysConfigModel-" + Id;
			...
			return (BWJS.Model.SysConfig)objModel;
		}*/
        ...
        /// 获得数据列表
        /// </summary>
        public List<BWJS.Model.SysConfig> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<BWJS.Model.SysConfig> DataTableToList(DataTable dt)
        {
            List<BWJS.Model.SysConfig> modelList = new List<BWJS.Model.SysConfig>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                BWJS.Model.SysConfig model;
