...
namespace BWJS.BLL {
    ...
    /// 身份信息
    /// </summary>
		public partial class NL_IdentityInfoBLL
	{
   		     
		private readonly BWJS.DAL.NL_IdentityInfoDAL dal=new BWJS.DAL.NL_IdentityInfoDAL();
		public NL_IdentityInfoBLL()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public BWJS.Model.NL_IdentityInfo GetModelByCache(int ConsultId)
		{
			
			string CacheKey = "NL_IdentityInfoModel-" + ConsultId;
			...
			return (BWJS.Model.NL_IdentityInfo)objModel;
		}*/
		...
		/// 获得数据列表
		/// </summary>
		public List<BWJS.Model.NL_IdentityInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<BWJS.Model.NL_IdentityInfo> DataTableToList(DataTable dt)
		{
			List<BWJS.Model.NL_IdentityInfo> modelList = new List<BWJS.Model.NL_IdentityInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				BWJS.Model.NL_IdentityInfo model;
