...
namespace BWJS.BLL
{
    ...
    {
        private readonly SysSettingsDAL dal = new SysSettingsDAL();
        ...
        public bool Delete(int SysSettingsId)
        {
            ...
            return dal.Delete(SysSettingsId);
        }
        /// <summary>
        /// 批量删除一批数据
        /// </summary>
        ...
        {
            return dal.DeleteList(SysSettingsIdlist);
        }
        ...
        public BWJS.Model.SysSettings GetModel(int SysSettingsId)
        {
            ...
            return dal.GetModel(SysSettingsId);
        }
        /*
		/// <summary>
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public BWJS.Model.SysSettings GetModelByCache(int SysSettingsId)
		{
			
			string CacheKey = "SysSettingsModel-" + SysSettingsId;
			object objModel = BWJS.Common.DataCache.GetCache(CacheKey);
			if (objModel == null)
			{
				try
				{
					objModel = dal.GetModel(SysSettingsId);
					if (objModel != null)
					{
			...
			return (BWJS.Model.SysSettings)objModel;
		}*/
        ...
        /// 获得数据列表
        /// </summary>
        public List<BWJS.Model.SysSettings> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<BWJS.Model.SysSettings> DataTableToList(DataTable dt)
        {
            List<BWJS.Model.SysSettings> modelList = new List<BWJS.Model.SysSettings>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                BWJS.Model.SysSettings model;
