...
namespace BWJS.BLL
{
    ...
    /// 联系人信息
    /// </summary>
    public partial class NL_ContactsBLL
    {
        private readonly BWJS.DAL.NL_ContactsDAL dal = new BWJS.DAL.NL_ContactsDAL();
        ...
        /// 获得数据列表
        /// </summary>
        public List<BWJS.Model.NL_Contacts> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<BWJS.Model.NL_Contacts> DataTableToList(DataTable dt)
        {
            List<BWJS.Model.NL_Contacts> modelList = new List<BWJS.Model.NL_Contacts>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                BWJS.Model.NL_Contacts model;
        ...
        {
            return dal.DeleteList(ContactIdlist, userId);
        }
        ...
        {
            return dal.DeleteList(consultIds);
        }
