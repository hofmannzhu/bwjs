<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/m1.Master" CodeBehind="SysConfigList.aspx.cs" Inherits="BWJS.WebApp.Admin.SysConfigList" %>
        ...
        <div class="add-box">
            <div class="form-inline">
                ...
                <%if (this.CheckedAuthorize("91uwrm"))
                    { %>
                <a class="btn btn-info" onclick="return ShowAdd(0)"><span class="glyphicon glyphicon-plus"></span>添加</a>
...
<asp:Content ID="Content6" ContentPlaceHolderID="footerContent" runat="server">
    <script type="text/javascript">
            ...
            machineTable = $("#machineList").dataTable({
                ...
                fnServerData: function (sUrl, aoData, fnCallback) {
                    ...
                    aoData.push(
                            { "name": "op", "value": "bwjs" },
                            { "name": "om", "value": "gl" },
                            { "name": "action", "value": "GetSysConfigList" },
        ...
        { %>
                            option = "<a data-toggle=\"modal\" data-target=\"#detailsModal\" data-action=\"orderCancle\" data-id=\"" + full.Id + "\" class=\"btn btn-mini\" title=\"查看详情\">查看</a>";
                            <%} %>

                            <%if (this.CheckedAuthorize("sb4iyg"))
        { %>
                            option += "<a class=\"btn btn-mini\" onclick=\"UpdateMachine(" + full.Id + "," + full.UserID + ")\" title=\"修改\">修改</a>";
                            <%} %>

                            <%if (this.CheckedAuthorize("2t4bua"))
        { %>
                            option += "<a class=\"btn btn-mini\" onclick=\"DeleteMachine(" + full.Id + ")\" title=\"删除\">删除</a>";
                              <%} %> 
