<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/m1.Master" AutoEventWireup="true" CodeBehind="UserBankList.aspx.cs" Inherits="BWJS.WebApp.Admin.UserBankList" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="footerContent" runat="server">
    <script type="text/javascript">
        ...
        { %>
                                    option = "<a class=\"btn btn-mini\" style=\"color:red;\" href=\"javascript:void(0)\" title=\"设为默认收款账户\" onclick=\"setIsDefault(" + full.UserBankId + ")\">设为默认</a>";
                                        <%} %>
                                }
        ...
        { %>
            ...
            function setIsDefault(userBankId) {
                var paramter = {};
                paramter.op = "bwjs";
                paramter.om = "gl";
