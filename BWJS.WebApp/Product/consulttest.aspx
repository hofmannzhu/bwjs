<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="consulttest.aspx.cs" Inherits="BWJS.WebApp.Product.consulttest" %>
        ...
        <form class="form-horizontal mar-top1" role="form" id="identityForm" enctype="application/x-www-form-urlencoded">
            <div class="col-sm-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" value="" name="Money" id="Money" placeholder="请输入金额" required data-msg-required="不能为空" data-msg-minlength="请输贷款金额" maxlength="18" /><em>*</em>
                    </div>
                </div>
    ...
    <div class="show1">
        <form method="post" class="form-horizontal mar-top1" role="form" id="bankCardForm">
            <div class="col-sm-12">
                ...
                <div class="form-group">
                    <label for="inpIdentityCardNumber" class="col-sm-3 control-label">所在城市：</label>
                    <div class="col-sm-8">
                        <select name="LoanUse" id="10" style="border-radius: 8px" class="form-control">
                            <%=strLoanUse %>
                        </select><em>*</em>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select name="LoanUse" id="9" style="border-radius: 8px" class="form-control">
                            <%=strLoanUse %>
                        </select><em>*</em>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="MonthlyIncome" class="col-sm-3 control-label">职业身份：</label>
                    <div class="col-sm-8">
                        <select name="LoanUse" id="8" style="border-radius: 8px" class="form-control">
                            <%=strLoanUse %>
                        </select><em>*</em>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="MonthlyIncome" class="col-sm-3 control-label">当前单位工作时间：</label>
                    <div class="col-sm-8">
                        <select name="LoanUse" id="7" style="border-radius: 8px" class="form-control">
                            <%=strLoanUse %>
                        </select><em>*</em>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="MonthlyIncome" class="col-sm-3 control-label">是否有本地公积金：</label>
                    <div class="col-sm-8">
                        <select name="LoanUse" id="6" style="border-radius: 8px" class="form-control">
                            <%=strLoanUse %>
                        </select><em>*</em>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="MonthlyIncome" class="col-sm-3 control-label">工资发放形式：</label>
                    <div class="col-sm-8">
                        <select name="LoanUse" id="5" style="border-radius: 8px" class="form-control">
                            <%=strLoanUse %>
                        </select><em>*</em>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="MonthlyIncome" class="col-sm-3 control-label">您的学历：</label>
                    <div class="col-sm-8">
                        <select name="LoanUse" id="4" style="border-radius: 8px" class="form-control">
                            <%=strLoanUse %>
                        </select><em>*</em>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="MonthlyIncome" class="col-sm-3 control-label">名下是否有车：</label>
                    <div class="col-sm-8">
                        <select name="LoanUse" id="3" style="border-radius: 8px" class="form-control">
                            <%=strLoanUse %>
                        </select><em>*</em>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="MonthlyIncome" class="col-sm-3 control-label">名下是否有房：</label>
                    <div class="col-sm-8">
                        <select name="LoanUse" id="2" style="border-radius: 8px" class="form-control">
                            <%=strLoanUse %>
                        </select><em>*</em>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="MonthlyIncome" class="col-sm-3 control-label">是否做过其他贷款：</label>
                    <div class="col-sm-8">
                        <select name="LoanUse" id="1" style="border-radius: 8px" class="form-control">
                            <%=strLoanUse %>
                        </select><em>*</em>
                    </div>
                </div>
