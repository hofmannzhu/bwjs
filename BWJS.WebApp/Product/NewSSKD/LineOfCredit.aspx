<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LineOfCredit.aspx.cs" Inherits="BWJS.WebApp.Product.NewSSKD.LineOfCredit" %>
<!DOCTYPE html>
            ...
            <form method="post" class="form-horizontal mar-top1" role="form" id="bankCardForm" action="/Product/NewSSKD/ApplyForConfirmation">
                <div class="col-sm-12  text-right" style="margin-top: 40px;">
                    <div class="form-group">
                        <label for="inpBankCardNo" class="col-lg-3 col-sm-3 col-xs-3 control-label">可授额度：</label>
