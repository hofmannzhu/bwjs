...
namespace UtilityHelper
{
    ...
    public class Utils
    {
        ...
        static public void MsgAlert(System.Web.UI.Page page, string msg)
        {
        ...
        /// <param name="page"></param>
        /// <param name="msg"></param>
        static public void MsgAlert(System.Web.UI.Page page, string msg, string url)
        {
            page.ClientScript.RegisterStartupScript(page.GetType(), "error", "<script language='javascript'>alert('" + msg + "');location.href='" + url + "';</script>");
        }
        ...
        static public void WriteCookie(string strName, string Key, string strValue)
        {
            HttpCookie cookie = HttpContext.Current.Request.Cookies[strName];
            cookie.Expires = DateTime.Now.AddHours(3);
            //cookie.Domain = ConfigurationManager.ConnectionStrings["Domain"].ToString();
            if (cookie == null)
            {
                cookie = new HttpCookie(strName);
                cookie.Values[Key] = strValue;
            }
            else
            {
                cookie.Values[Key] = strValue;
        ...
        static public void WriteCookie(string strName, string key, string strValue, int Expires)
        {
            HttpCookie cookie = HttpContext.Current.Request.Cookies[strName];
            //cookie.Domain = ConfigurationManager.ConnectionStrings["Domain"].ToString();
            if (cookie == null)
        ...
        static public void DelCoookie(string strCookieName)
        {
            HttpCookie objCookie = new HttpCookie(strCookieName.Trim());
            //objCookie.Domain = ConfigurationManager.ConnectionStrings["Domain"].ToString();
        ...
        /// </summary>
        /// <param name="strName">Cookie对象名称</param>
        /// <param name="key">Key键名</param>
        ...
        static public string GetCookie(string strName, string key)
        {
        ...
        /// <param name="strName">名称</param>
        /// <returns>cookie值</returns>
        static public HttpCookie GetCookie(string strName)
        {
        ...
        /// 返回随机码
        /// </summary>
        /// <param name="ws">位数</param>
        /// <param name="zm">是否包含字母</param>
        /// <returns></returns>
        static public string GenRandomCode(int ws, bool zm)
        {
            var result = "";
            var random = new Random((int)DateTime.Now.Ticks);
            string textArray = "0123456789";
            if (zm)
            {
                textArray += "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
            }
        ...
        /// 删除字符串中的所有HTML标签
        /// </summary>
        /// <param name="Htmlstring">包含HTML标签的字符串</param>
        /// <returns>返回被清空HTML标签的字符串</returns>
        static public string ClearHTMLTag(string Htmlstring)
        {
            //删除脚本
        ...
        /// </summary>
        /// <returns></returns>
        static public string GetCurrentAppPath()
        {
        ...
        static public void CreateThumbImage(string srcfile, string dstfile)
        {
            ...
            {
                //原图加载 
                using (System.Drawing.Image sourceImage = System.Drawing.Image.FromFile(srcfile))
                {
                    //原图宽度和高度 
                    ...
                    using (System.Drawing.Image bitmap = new System.Drawing.Bitmap(smallWidth, smallHeight))
                    {
                        ...
                        using (System.Drawing.Image bitmap1 = new System.Drawing.Bitmap(intThumbWidth, intThumbHeight))
                        {
                            ...
                            using (System.Drawing.Graphics g = System.Drawing.Graphics.FromImage(bitmap1))
                            {
                                ...
                                using (System.Drawing.Image genimage = System.Drawing.Image.FromFile(Utils.GetCurrentAppPath() + @"Public\thumbbg\Thumb_1.png"))
                                {
                                    using (System.Drawing.Graphics g2 = System.Drawing.Graphics.FromImage(genimage))
                                    {
                                        g2.DrawImage(bitmap1, 12, 12);
                                        g2.Dispose();
                                        genimage.Save(dstfile, System.Drawing.Imaging.ImageFormat.Jpeg);
                                    }
                                }
                            }
                        }
        ...
        //static public ILog getLogger(string logName)
        //{
        //    string curpath = System.AppDomain.CurrentDomain.BaseDirectory;

        //    FileInfo log4netConfig = new FileInfo(curpath + "log4net.config");
        ...
        static public Regex RegexFont = new Regex(@"<font color=" + "\".*?\"" + @">([\s\S]+?)</font>", Utils.GetRegexCompiledOptions());
        ...
        static public RegexOptions GetRegexCompiledOptions()
        {
        ...
        static public bool IsCompriseStr(string str, string stringarray, string strsplit)
        {
        ...
        static public int GetInArrayID(string strSearch, string[] stringArray, bool caseInsensetive)
        {
            for (int i = 0; i < stringArray.Length; i++)
            {
                if (caseInsensetive)
        ...
        /// <param name="stringArray">字符串数组</param>
        /// <returns>字符串在指定字符串数组中的位置, 如不存在则返回-1</returns>		
        static public int GetInArrayID(string strSearch, string[] stringArray)
        {
        ...
        static public bool InArray(string strSearch, string[] stringArray, bool caseInsensetive)
        {
        ...
        /// <param name="stringarray">字符串数组</param>
        /// <returns>判断结果</returns>
        static public bool InArray(string str, string[] stringarray)
        {
        ...
        /// <returns>判断结果</returns>
        static public bool InArray(string str, string stringarray, string strsplit)
        {
        ...
        /// <param name="caseInsensetive">是否不区分大小写, true为不区分, false为区分</param>
        /// <returns>判断结果</returns>
        static public bool InArray(string str, string stringarray, string strsplit, bool caseInsensetive)
        {
        ...
        static public string ClearBR(string str)
        {
            Match m = null;
        ...
        static public string CutString(string str, int startIndex, int length)
        {
            if (startIndex >= 0)
            {
                if (length < 0)
        ...
        /// <param name="startIndex">子字符串的起始位置</param>
        /// <returns>子字符串</returns>
        static public string CutString(string str, int startIndex)
        {
        ...
        static public string GetMapPath(string strPath)
        {
        ...
        static public void ResponseFile(string filepath, string filename, string filetype)
        {
            Stream iStream = null;
        ...
        static public bool IsImgFilename(string filename)
        {
        ...
        static public string IntToStr(int intValue)
        {
        ...
        static public string GetSubString(string p_SrcString, int p_Length, string p_TailString)
        {
            return GetSubString(p_SrcString, 0, p_Length, p_TailString);
        }

        static public string GetUnicodeSubString(string str, int len, string p_TailString)
        {
        ...
        /// <param name="p_TailString">用于替换的字符串</param>
        /// <returns>截取后的字符串</returns>
        static public string GetSubString(string p_SrcString, int p_StartIndex, int p_Length, string p_TailString)
        {
        ...
        /// 自定义的替换字符串函数
        /// </summary>
        static public string ReplaceString(string SourceString, string SearchString, string ReplaceString, bool IsCaseInsensetive)
        {
        ...
        /// 生成指定数量的html空格符号
        /// </summary>
        static public string GetSpacesString(int spacesCount)
        {
            StringBuilder sb = new StringBuilder();
        ...
        /// <returns>判断结果</returns>
        static public bool IsValidEmail(string strEmail)
        {
            return Regex.IsMatch(strEmail, @"^[\w\.]+([-]\w+)*@[A-Za-z0-9-_]+[\.][A-Za-z0-9-_]");
        }

        static public bool IsValidDoEmail(string strEmail)
        {
        ...
        /// <returns>判断结果</returns>
        static public bool IsURL(string strUrl)
        {
            return Regex.IsMatch(strUrl, @"^(http|https)\://([a-zA-Z0-9\.\-]+(\:[a-zA-Z0-9\.&%\$\-]+)*@)*((25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[1-9])\.(25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[1-9]|0)\.(25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[1-9]|0)\.(25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[0-9])|localhost|([a-zA-Z0-9\-]+\.)*[a-zA-Z0-9\-]+\.(com|edu|gov|int|mil|net|org|biz|arpa|info|name|pro|aero|coop|museum|[a-zA-Z]{1,10}))(\:[0-9]+)*(/($|[a-zA-Z0-9\.\,\?\'\\\+&%\$#\=~_\-]+))*$");
        }

        static public string GetEmailHostName(string strEmail)
        {
        ...
        /// <returns>判断结果</returns>
        static public bool IsSafeSqlString(string str)
        {
        ...
        /// <param name="str">要判断字符串</param>
        /// <returns>判断结果</returns>
        static public bool IsSafeUserInfoString(string str)
        {
        ...
        /// 替换回车换行符为html换行符
        /// </summary>
        static public string StrFormat(string str)
        {
            string str2;
        ...
        /// 返回指定日期格式
        /// </summary>
        static public string GetDate(string datetimestr, string replacestr)
        {
            if (datetimestr == null)
                return replacestr;
        ...
        /// 返回相对于当前时间的相对天数
        /// </summary>
        static public string GetDateTime(int relativeday)
        {
        ...
        /// 返回标准时间格式string
        /// </summary>
        static public string GetDateTimeF()
        {
        ...
        /// 返回标准时间 
        /// </sumary>
        static public string GetStandardDateTime(string fDateTime, string formatStr)
        {
        ...
        /// </sumary>
        static public string GetStandardDateTime(string fDateTime)
        {
        ...
        /// 返回标准时间 yyyy-MM-dd
        /// </sumary>
        static public string GetStandardDate(string fDate)
        {
        ...
        /// </summary>
        /// <returns></returns>
        static public bool IsTime(string timeval)
        {
        ...
        /// 改正sql语句中的转义字符
        /// </summary>
        static public string mashSQL(string str)
        {
        ...
        /// 替换sql语句中的有问题符号
        /// </summary>
        static public string ChkSQL(string str)
        {
            return (str == null) ? "" : str.Replace("'", "''");
        }
        ...
        /// 分割字符串
        /// </summary>
        static public string[] SplitString(string strContent, string strSplit)
        {
        ...
        /// </summary>
        /// <returns></returns>
        static public string[] SplitString(string strContent, string strSplit, int count)
        {
        ...
        /// <returns></returns>
        static public string[] PadStringArray(string[] strArray, int minLength, int maxLength)
        {
        ...
        /// <returns></returns>
        static public string[] SplitString(string strContent, string strSplit, bool ignoreRepeatItem, int maxElementLength)
        {
        ...
        static public string[] SplitString(string strContent, string strSplit, bool ignoreRepeatItem, int minElementLength, int maxElementLength)
        {
            string[] result = SplitString(strContent, strSplit);
        ...
        /// <param name="ignoreRepeatItem">忽略重复项</param>
        /// <returns></returns>
        static public string[] SplitString(string strContent, string strSplit, bool ignoreRepeatItem)
        {
        ...
        /// <returns></returns>
        static public string[] DistinctStringArray(string[] strArray, int maxElementLength)
        {
        ...
        /// <param name="strArray">字符串数组</param>
        /// <returns></returns>
        static public string[] DistinctStringArray(string[] strArray)
        {
        ...
        /// 替换html字符
        /// </summary>
        static public string EncodeHtml(string strHtml)
        {
            if (strHtml != "")
            {
        ...
        /// 进行指定的替换(脏字过滤)
        /// </summary>
        static public string StrFilter(string str, string bantext)
        {
            string text1 = "", text2 = "";
        ...
        static public string GetStaticPageNumbers(int curPage, int countPage, string url, string expname, int extendPage)
        {
        ...
        /// <returns>页码html</returns>
        static public string GetStaticPageNumbers(int curPage, int countPage, string url, string expname, int extendPage, int forumrewrite)
        {
            int startPage = 1;
            int endPage = 1;
        ...
        /// <param name="extendPage">周边页码显示个数上限</param>
        /// <returns>页码html</returns>
        static public string GetPostPageNumbers(int countPage, string url, string expname, int extendPage)
        {
            int startPage = 1;
            int endPage = 1;
            int curPage = 1;
        ...
        /// <param name="extendPage">周边页码显示个数上限</param>
        /// <returns>页码html</returns>
        static public string GetPageNumbers(int curPage, int countPage, string url, int extendPage)
        {
        ...
        /// <returns>页码html</returns>
        static public string GetPageNumbers(int curPage, int countPage, string url, int extendPage, string pagetag)
        {
        ...
        /// <returns>页码html</returns>
        static public string GetPageNumbers(int curPage, int countPage, string url, int extendPage, string pagetag, string anchor)
        {
            if (pagetag == "")
                pagetag = "page";
            int startPage = 1;
        ...
        static public string[] FindNoUTF8File(string Path)
        {
        ...
        /// <returns></returns>
        static public string FormatBytesStr(int bytes)
        {
            if (bytes > 1073741824)
        ...
        /// <returns></returns>
        static public int StrDateDiffSeconds(string time, int Sec)
        {
        ...
        /// <returns></returns>
        static public int StrDateDiffMinutes(string time, int minutes)
        {
            if (Utils.StrIsNullOrEmpty(time))
                return 1;
            DateTime dateTime = TypeConverter.StrToDateTime(time, DateTime.Parse("1900-01-01"));
        ...
        /// <returns></returns>
        static public int StrDateDiffHours(string time, int hours)
        {
            if (Utils.StrIsNullOrEmpty(time))
                return 1;
        ...
        /// <returns></returns>
        static public bool CreateDir(string name)
        {
        ...
        /// <param name="str"></param>
        /// <returns></returns>
        static public string ReplaceStrToScript(string str)
        {
        ...
        static public bool IsIPSect(string ip)
        {
        ...
        /// <returns></returns>
        static public bool InIPArray(string ip, string[] iparray)
        {
        ...
        /// </summary>
        /// <returns></returns>
        static public string GetAssemblyProductName()
        {
        ...
        /// </summary>
        /// <returns></returns>
        static public string GetAssemblyCopyright()
        {
        ...
        /// <param name="strName">名称</param>
        /// <param name="strValue">值</param>
        static public void WriteCookie(string strName, string strValue)
        {
            HttpCookie cookie = HttpContext.Current.Request.Cookies[strName];
            if (cookie == null)
            {
        ...
        static public void WriteCookie(string strName, string strValue, int expires)
        {
            HttpCookie cookie = HttpContext.Current.Request.Cookies[strName];
            if (cookie == null)
            {
        ...
        /// </summary>
        /// <returns></returns>
        static public string GetTrueForumPath()
        {
        ...
        /// <returns></returns>
        static public string RemoveHtml(string content)
        {
        ...
        /// <param name="content"></param>
        /// <returns></returns>
        static public string RemoveUnsafeHtml(string content)
        {
        ...
        /// <returns></returns>
        static public string RemoveFontTag(string title)
        {
        ...
        static public bool StrToBool(object expression, bool defValue)
        {
        ...
        /// <param name="defValue">缺省值</param>
        /// <returns>转换后的bool类型结果</returns>
        static public bool StrToBool(string expression, bool defValue)
        {
            return TypeConverter.StrToBool(expression, defValue);
        }
        ...
        static public int StrToInt(object expression, int defValue)
        {
        ...
        /// <param name="defValue">缺省值</param>
        /// <returns>转换后的int类型结果</returns>
        static public int StrToInt(string expression, int defValue)
        {
        ...
        /// <param name="defValue">缺省值</param>
        /// <returns>转换后的int类型结果</returns>
        static public float StrToFloat(object strValue, float defValue)
        {
        ...
        static public string AdDeTime(int times)
        {
        ...
        static public bool IsRuleTip(Hashtable NewHash, string ruletype, out string key)
        {
            key = "";
        ...
        /// <param name="str"></param>
        /// <returns></returns>
        static public string ClearLastChar(string str)
        {
        ...
        static public bool BackupFile(string sourceFileName, string destFileName, bool overwrite)
        {
        ...
        /// <param name="destFileName">目标文件名</param>
        /// <returns>操作是否成功</returns>
        static public bool BackupFile(string sourceFileName, string destFileName)
        {
        ...
        /// <returns>操作是否成功</returns>
        static public bool RestoreFile(string backupFileName, string targetFileName, string backupTargetFileName)
        {
            try
            {
        ...
        static public bool RestoreFile(string backupFileName, string targetFileName)
        {
        ...
        /// </summary>
        /// <returns></returns>
        static public string GetTemplateCookieName()
        {
        ...
        /// <returns></returns>
        static public string SBCCaseToNumberic(string SBCCase)
        {
        ...
        /// <returns></returns>
        static public string ConvertSimpleFileName(string fullname, string repstring, int leftnum, int rightnum, int charnum)
        {
        ...
        /// <returns></returns>
        static public StringBuilder DataTableToJSON(System.Data.DataTable dt)
        {
        ...
        /// <returns></returns>
        static public StringBuilder DataTableToJson(System.Data.DataTable dt, bool dt_dispose)
        {
        ...
        /// <param name="str"></param>
        /// <returns></returns>
        static public bool StrIsNullOrEmpty(string str)
        {
        ...
        /// <returns></returns>
        static public bool CheckColorValue(string color)
        {
        ...
        /// <param name="extendPage">周边页码显示个数上限</param>
        /// <returns></returns>
        static public string GetAjaxPageNumbers(int curPage, int countPage, string callback, int extendPage)
        {
            string pagetag = "page";
            int startPage = 1;
            int endPage = 1;
        ...
        /// <returns></returns>
        static public string GetSourceTextByUrl(string url)
        {
            try
            {
        ...
        static public DateTime GetUnixDateTimeByMilliseconds(long unix)
        {
            //long unix = 1500863191;
            DateTime dtStart = TimeZone.CurrentTimeZone.ToLocalTime(new DateTime(1970, 1, 1));
        ...
        /// <summary>
        /// .net开发中计算的都是标准时区的差，但java的解析时间跟时区有关，而我们的java服务器系统时区不是标准时区，解析时间会差8个小时。
        /// </summary>
        /// <param name="milliseconds"></param>
        /// <returns></returns>
        static public DateTime MillisecondsToDateTime(long milliseconds)
        {
        ...
        static public string JsonCharFilter(string sourceStr)
        {
        ...
        static public string MergeString(string source, string target)
        {
        ...
        static public string MergeString(string source, string target, string mergechar)
        {
        ...
        static public string ClearUBB(string sDetail)
        {
        ...
        /// </summary>
        /// <returns></returns>
        static public string GetRootUrl(string forumPath)
        {
        ...
        /// <returns>目录</returns>
        static public string GetFileDir(string fileName)
        {
        ...
        static public string GetHttpWebResponse(string url)
        {
        ...
        /// <returns></returns>
        static public string GetHttpWebResponse(string url, string postData)
        {
        ...
        /// <param name="defValue">缺省值</param>
        /// <returns></returns>
        static public T GetEnum<T>(string value, T defValue)
        {
            try
            {
        ...
        /// <returns></returns>
        static public string FormatDate(int date, bool chnType)
        {
        ...
        /// </summary>
        /// <returns></returns>
        static public string GetClientBrower()
        {
        ...
        /// </summary>
        static public void RestartIISProcess()
        {
            try
            {
        ...
        static public void WriteLog(string logpath, string data)
        {
            try
            {
                if (string.IsNullOrEmpty(logpath))
                {
                    logpath = HttpContext.Current.Server.MapPath("/LogData/" + DateTime.Now.ToString("yyyyMMdd") + ".log");
                }
                data = "\r\n" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "\r\n" + data;
                System.IO.File.AppendAllText(logpath, data, System.Text.Encoding.Default);
            }
            catch (Exception ex)
            {
                if (string.IsNullOrEmpty(logpath))
                {
                    logpath = HttpContext.Current.Server.MapPath("/LogData/test" + DateTime.Now.ToString("yyyyMMdd") + ".log");
                }
                System.IO.File.AppendAllText(logpath, ex.Message, System.Text.Encoding.Default);
            }
        }
    }
}
