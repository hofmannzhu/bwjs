/*==========================================================================================
*
*    Developed By 夏小进-Kevin
*
*    Create Date 2015-09-15  Tuesday
*
*    Description：社区数据库的操作类
*
*===========================================================================================*/
...
{
    /// <summary>
    /// <para>Author：程晨龙</para>
    /// <para>Date：2017年9月9日</para>
    /// <para></para>
    /// </summary>
    public abstract class DbHelperSQL
    {
        //数据库连接字符串(web.config来配置)，可以动态更改connectionString支持多数据库.		
        //public static string connectionString = ConfigurationManager.ConnectionStrings["MofangConn"].ConnectionString;
        static string secretKey = ConstantsConfig.secretKey;
        public static string connectionString
        {
            get
            {
                string connectionString = ConfigurationManager.ConnectionStrings["MofangConn"].ConnectionString;
