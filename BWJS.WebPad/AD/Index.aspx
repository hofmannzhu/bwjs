        ...
        window.onload =
            ...
            function GetList() {
                $.ajax({
                    ...
                    data: { Action: "GetAdPostionReleaseList", typeId: 2 },
                    success: function (data) {
                        var htmlData = "";
                        var lunBoNmbData = "";
                        var classdata = "";
                        ...
                        if (data != null) {
                            for (var k = 0; k < lengtht; k++) {
                                if ('<%=u%>' == "1") {
                                    htmlData += "<div><a href=\"javascript:;\" class=\"pm-slide-a\"><img src='http://39.106.63.46" + data[k].DefaultPicUrl + "'   alt=\"\"/></a></div>";
                                } else {
                                    htmlData += "<div><a href=\"javascript:;\" class=\"pm-slide-a\"><img src='http://39.106.63.46" + data[k].FilePath + "'   alt=\"\"/></a></div>";
                                }
                                if (k == 0) {
                                    classdata = "'class=on'";
                                } else {
