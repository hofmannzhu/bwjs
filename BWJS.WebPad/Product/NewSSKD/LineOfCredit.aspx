<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LineOfCredit.aspx.cs" Inherits="BWJS.WebPad.Product.NewSSKD.LineOfCredit" %>
<!DOCTYPE html>
            ...
            <form method="post" class="form-horizontal mar-top1" role="form" id="bankCardForm" action="/Product/NewSSKD/ApplyForConfirmation">
                <div class="col-sm-12  text-right">
                    <div class="form-group">
                        <label for="inpBankCardNo" class="col-lg-3 col-sm-3 col-xs-3 control-label">可授信额度：</label>
                          <div class="col-lg-8 col-sm-8 col-xs-8">
                            <input type="text" value="" id="inpBankCardMobileValidCode" name="inpBankCardMobileValidCode" onkeyup="this.value=this.value.replace(/\D/g,'');" maxlength="6" class="form-control" placeholder="可授信额度5000-20000元" data-msg-required="不能为空" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-sm-8 col-xs-8 text-left">
                            <input type="text" class="form-control" id="inpBankCardNo" name="inpBankCardNo" onkeyup="CheckbankNum(this)" maxlength="30" placeholder="请输入商家账号" data-msg-required="不能为空" data-msg-age="用户唯一标识" required />
                        </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-lg-8 col-sm-8 col-xs-8 text-left">
                            <input type="text" class="form-control" id="inpBankCardNo" name="inpBankCardNo" onkeyup="CheckbankNum(this)" maxlength="30" placeholder="请输入商家授权密码" data-msg-required="不能为空" data-msg-age="用户唯一标识" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-sm-8 col-xs-8">
                            <input type="text" value="" id="inpBankCardMobileValidCode" name="inpBankCardMobileValidCode" onkeyup="this.value=this.value.replace(/\D/g,'');" maxlength="6" class="form-control" placeholder="请输入商家身份证号" data-msg-required="不能为空" />
                        </div>
                    </div>
